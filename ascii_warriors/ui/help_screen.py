...
All of that happened before you arrived, and all of it is written down. Press L
...
Butcher corpses with 'b' for meat, bone and hide. Build a fire with 'B' and
cook the meat with 'c' -- raw meat feeds you far less.

Torches burn down. Underground you can see almost nothing without one.
