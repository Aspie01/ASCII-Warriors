...
JOB_LABELS: Dict[str, Tuple[str, Color]] = {
    ...
    "engrave": ("Engraving", colors.Color(210, 200, 160)),
    "chop": ("Felling a tree", colors.Color(150, 200, 130)),
    "gather": ("Gathering plants", colors.Color(150, 210, 150)),
    "sand": ("Gathering sand", colors.Color(226, 206, 150)),
    "remove": ("Removing a construction", colors.Color(200, 140, 130)),
    "fish": ("Fishing", colors.Color(140, 190, 220)),
    "pull": ("Pulling a lever", colors.Color(200, 190, 150)),
    "tend": ("Tending livestock", colors.Color(190, 200, 150)),
    "slaughter": ("Slaughtering", colors.Color(200, 130, 130)),
