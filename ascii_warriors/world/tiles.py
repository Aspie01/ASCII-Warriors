...
TILES: Dict[str, TileDef] = {
    ...
    for t in (
        ...
        _t("coal_seam", "coal seam", "*", colors.Color(70, 66, 72), False,
           False, "WALL", "DIGGABLE", "ORE", climb=True, material="coal",
           desc="Fuel, sitting in the rock waiting to be dug."),
        _t("adamantine_vein", "raw adamantine", "*", colors.Color(140, 226, 232),
           False, False, "WALL", "DIGGABLE", "ORE", climb=True,
           material="adamantine",
           desc="Blue-green light in the rock. Nothing else looks like it."),
        _t("warm_stone", "warm stone", "#", colors.Color(150, 96, 72), False,
           False, "WALL", "DIGGABLE", "WARM", climb=True, material="basalt",
           desc="Warm to the touch. There is magma under this."),
        _t("obsidian_wall", "obsidian", "#", colors.Color(52, 44, 62), False,
           False, "WALL", "DIGGABLE", climb=True, material="obsidian",
           desc="Magma met water here and lost."),
        ...
        _t("shrub", "shrub", '"', colors.Color(86, 140, 72), True, True,
           "FLAMMABLE"),
        _t("ash", "ash", ".", colors.Color(96, 92, 88), True, True, "FLOOR",
           material="charcoal",
           desc="Something burned here. It is still warm."),
        ...
        _t("coffer", "coffer", "=", colors.Color(180, 150, 90), False, True,
           "FURNITURE", "CONTAINER"),
        _t("coffin", "coffin", "∩", colors.Color(186, 178, 166), False,
           True, "FURNITURE", "CONTAINER",
           desc="Somewhere for one dwarf to be, after."),
        ...
        _t("lever", "lever", "\\", colors.Color(200, 180, 120), True, True,
           "FLOOR", "FURNITURE", "CONSTRUCTED"),
        _t("floodgate_open", "open floodgate", "'", colors.Color(150, 175, 200),
           True, True, "FLOOR", "CONSTRUCTED", "GATE"),
        _t("floodgate_shut", "floodgate", "#", colors.Color(120, 150, 180),
           False, False, "WALL", "CONSTRUCTED", "GATE"),
        _t("bridge_down", "bridge", "=", colors.Color(150, 112, 66), True, True,
           "FLOOR", "CONSTRUCTED", "GATE"),
        _t("bridge_up", "raised bridge", "#", colors.Color(130, 96, 58), False,
           False, "WALL", "CONSTRUCTED", "GATE"),
