...
_FACET_PHRASES: Dict[str, Tuple[str, str]] = {
    "bravery": ("is incredibly brave", "is a coward"),
    "cheer": ("is always in good spirits", "is given to dark moods"),
    "anxiety": ("is a nervous wreck", "is never anxious"),
    "anger": ("has a quick temper", "is slow to anger"),
    "greed": ("is very greedy", "has no interest in wealth"),
    "curiosity": ("has a boundless curiosity", "is incurious"),
    "friendliness": ("is warm and friendly", "is cold to others"),
    "pride": ("is immensely proud", "has no vanity"),
    "envy": ("is prone to envy", "never envies others"),
    "stubbornness": ("is incredibly stubborn", "is easily swayed"),
    "discipline": ("is highly disciplined", "lacks all discipline"),
    "vengefulness": ("nurses grudges forever", "forgives readily"),
    "confidence": ("is supremely self-confident", "doubts everything"),
    "gregariousness": ("loves a crowd", "prefers solitude"),
    "ambition": ("burns with ambition", "has no ambition"),
    "trust": ("trusts others easily", "trusts nobody"),
    "humour": ("finds humour everywhere", "has no sense of humour"),
    "altruism": ("gives freely to others", "looks out only for themselves"),
    "hate_propensity": ("takes an easy dislike to others", "rarely hates anyone"),
    "love_propensity": ("forms deep attachments", "does not form attachments"),
    "cruelty": ("has a cruel streak", "cannot bear cruelty"),
    "perseverance": ("never gives up", "abandons things easily"),
    "excitement_seeking": ("craves excitement", "avoids all excitement"),
    "imagination": ("has a vivid imagination", "is entirely literal-minded"),
    "swayed_by_emotions": ("is ruled by emotion", "is unmoved by emotion"),
    "activity_level": ("is always in motion", "is deeply sedentary"),
    "orderliness": ("keeps everything in order", "lives in disarray"),
    "politeness": ("is unfailingly polite", "is blunt to the point of rudeness"),
    "assertiveness": ("speaks their mind forcefully", "avoids confrontation"),
    "tolerance": ("tolerates anything", "is deeply intolerant"),
}
